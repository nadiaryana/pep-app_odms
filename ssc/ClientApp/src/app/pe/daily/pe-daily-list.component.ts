...
export class PeDailyListComponent implements OnInit {
  ...
  displayedColumns: string[] = ["select", "date","well","zone","interval","test_date","test_duration","last_prod_hours","last_prod_gross","last_prod_net","last_prod_wc","gas","art_lift_size","art_lift_type","art_lift_sl","art_lift_spm","art_lift_freq","art_lift_load","art_lift_bean_size","thp","chp","pfl","psep","pump_intake","top","mid","bottom","pump_capacity","pump_efficiency","sonolog_date","sonolog_dfl","sonolog_sfl","sm","ps","pwf","qmax","well_efficiency"];
  headerColumns1: string[] = ["select", "date","well","zone","interval","test_date","test_duration","last_prod","gas","art_lift","thp","chp","pfl","psep","pump_intake","perforation_depth","pump_capacity","pump_efficiency","sonolog","sm","ps","pwf","qmax","well_efficiency"];
  headerColumns2: string[] = ["last_prod_hours","last_prod_gross","last_prod_net","last_prod_wc","art_lift_size","art_lift_type","art_lift_sl","art_lift_spm","art_lift_freq","art_lift_load","art_lift_bean_size","top","mid","bottom","sonolog_date","sonolog_dfl","sonolog_sfl"]
