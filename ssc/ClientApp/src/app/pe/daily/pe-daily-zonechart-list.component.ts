...
export class PeDailyZonechartListComponent implements OnInit {
  ...
  displayedColumns: string[] = ["select", "date","well","zone","interval","test_date","test_duration","last_prod_hours","last_prod_gross","last_prod_net","last_prod_wc"];
  headerColumns1: string[] = ["select", "date","well","zone","interval","test_date","test_duration","last_prod"];
  headerColumns2: string[] = ["last_prod_hours","last_prod_gross","last_prod_net","last_prod_wc"]
  ...
  deleteSelected() {
    ...
    const dialogRef = this.dialog.open(PeDailyZoneChartDeleteDialogComponent, {
      width: '250px',
...
export class PeDailyZoneChartDeleteDialogComponent {

  constructor(
    public dialogRef: MatDialogRef<PeDailyZoneChartDeleteDialogComponent>,
