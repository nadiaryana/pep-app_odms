...
@Component({
  ...
  templateUrl: './ssc-ticket-list.component.html',
  styleUrls: ['./ssc-ticket.scss']
})
export class SscTicketListComponent implements OnInit {

  displayedColumns: string[] = ["id", "type", "displayId", "summary", "customer_fullName", "customer_company", "customer_site", "customer_pa", "customer_psa", "customer_department", "assignee_fullName", "assignee_loginId", "assignee_group", "priority", "status_value", "status_reason", "supportGroup_name", "submitDate", "completedDate", "slaStatus", "modifiedDate", "Actions"];
  ...
  id_xSelected:any[] = [];
  type_xSelected:any[] = [];
  displayId_xSelected:any[] = [];
  summary_xSelected:any[] = [];
  customer_fullName_xSelected:any[] = [];
  customer_company_xSelected:any[] = [];
  customer_site_xSelected:any[] = [];
  customer_pa_xSelected:any[] = [];
  customer_psa_xSelected:any[] = [];
  customer_department_xSelected:any[] = [];
  assignee_fullName_xSelected:any[] = [];
  assignee_loginId_xSelected:any[] = [];
  assignee_group_xSelected:any[] = [];
  priority_xSelected:any[] = [];
  status_value_xSelected:any[] = [];
  status_reason_xSelected:any[] = [];
  supportGroup_name_xSelected = [];
  submitDate_xSelected:any[] = [];
  completedDate_xSelected:any[] = [];
  slaStatus_xSelected:any[] = [];
  modifiedDate_xSelected:any[] = [];
  ...
  ngOnInit() {
    ...
    if(submitDateVal.length > 0) this.xfilterService.updateSelected({ column: "submitDate", selected: submitDateVal});
...
export class ExampleHttpDao {
  ...
  getRepoIssues(sort: string, order: string, page: number, pagesize: number = 25, filter: string, columnfilter: object, mode: string = "", httpOption: object = {}): Observable<SscTicketApi> {
