...
var WowsDashboardComponent = /** @class */ (function () {
    function WowsDashboardComponent(http, titleService, commonService, route, router) {
        this.http = http;
    ...
    WowsDashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.dateControl.valueChanges.subscribe(function (r) {
            _this.refresh_Production();
            //this.refresh_Gas();
            _this.refresh_WellStatus();
            // this.refresh_StructureProduction();
            // this.refresh_WellProduction();
            _this.refresh_WellRank();
            //this.refresh_SOT();
        });
    ...
    WowsDashboardComponent.prototype.dateChange = function (evt) {
        this.dateInput = evt.value.toLocaleDateString("en-US", { month: "short", year: "numeric", day: "numeric" });
    };
    WowsDashboardComponent.prototype.refresh_SOT = function () {
        var _this = this;
        this.isLoadingSOT = true;
        this.http.get('/api/pe/production/ProdVolume', { params: { FacilityName: "SANGASANGA", date: this.dateControl.value.toISOString() } }).subscribe(function (res) {
            _this.valueSOT = res["PeriodVolumeValue"];
            _this.isLoadingSOT = false;
        }, function (error) {
        }, function () {
        });
    };
    WowsDashboardComponent.prototype.refresh_Production = function () {
        var _this = this;
        ...
        this.http.get('/api/pe/production', { params: { sort: 'date', order: 'asc', columnfilter: '{"date":[{"opr":"gte","val":"' + start_date.toISOString() + '","log":"and"},{"opr":"lte","val":"' + end_date.toISOString() + '","log":"and"}]}' } }).subscribe(function (res) {
            var categories = [];
            var series_operation = [];
            var series_sot = [];
            var series_figure = [];
            var series_gas = [];
            res["items"].map(function (d) {
                ...
                if (_this.dateControl.value.toLocaleDateString("id-ID") == new Date(d.date).toLocaleDateString("id-ID")) {
                    _this.valueSOT = d.sot;
                    _this.valueFigure = d.figure;
                    _this.valueGas = d.gas / 1000;
                    _this.valueOperation = d.operation;
                }
            });
            _this.oil_chart_options["xAxis"]["categories"] = categories;
            _this.oil_chart_options["series"][0]["data"] = series_operation;
            _this.oil_chart_options["series"][1]["data"] = series_sot;
            _this.oil_chart_options["series"][2]["data"] = series_figure;
            highcharts__WEBPACK_IMPORTED_MODULE_5__["chart"](_this.oil_chart_el.nativeElement, _this.oil_chart_options);
            _this.gas_chart_options["xAxis"]["categories"] = categories;
            _this.gas_chart_options["series"][0]["data"] = series_gas;
            highcharts__WEBPACK_IMPORTED_MODULE_5__["chart"](_this.gas_chart_el.nativeElement, _this.gas_chart_options);
            _this.isLoadingProduction = false;
        }, function (error) {
        }, function () {
        });
    };
    WowsDashboardComponent.prototype.refresh_Gas = function () {
        var _this = this;
        this.http.get('/api/pe/data', { params: { type: "structure_production", date: this.dateControl.value.toISOString() } }).subscribe(function (res) {
            var categories = [];
            ...
            _this.gas_chart_options["xAxis"]["categories"] = categories;
            _this.gas_chart_options["series"] = series;
            highcharts__WEBPACK_IMPORTED_MODULE_5__["chart"](_this.gas_chart_el.nativeElement, _this.gas_chart_options);
        }, function (error) {
        }, function () {
        });
    };
    WowsDashboardComponent.prototype.refresh_WellStatus = function () {
        var _this = this;
        this.http.get('/api/pe/data', { params: { type: "well_status", date: this.dateControl.value.toISOString() } }).subscribe(function (res) {
            var series_data = [];
            res["data"].map(function (d) {
                d.count < 10 ? series_data.push({ name: d.status, y: d.count, dataLabels: { distance: 10 } }) : series_data.push({ name: d.status, y: d.count });
            });
            _this.wellstat_chart_options["series"][0]["data"] = series_data;
            highcharts__WEBPACK_IMPORTED_MODULE_5__["chart"](_this.wellstat_chart_el.nativeElement, _this.wellstat_chart_options);
            _this.active_wells_count = res["active_wells_count"];
            ...
            _this.active_well_chart_options["xAxis"]["categories"] = date_category;
            _this.active_well_chart_options["series"][0]["data"] = act_well_series_data;
            highcharts__WEBPACK_IMPORTED_MODULE_5__["chart"](_this.active_well_chart_el.nativeElement, _this.active_well_chart_options);
        }, function (error) {
        }, function () {
        });
    };
     ...
     */
    WowsDashboardComponent.prototype.refresh_WellRank = function () {
        var _this = this;
        this.http.get('/api/pe/data', { params: { type: "well_rank", date: this.dateControl.value.toISOString() } }).subscribe(function (res) {
            var categories = [];
            ...
            _this.wellrank_chart_options["yAxis"].max = Math.max.apply(Math, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](series[0]["data"]));
            _this.wellrank_chart_options["xAxis"]["categories"] = categories;
            _this.wellrank_chart_options["series"] = series;
            highcharts__WEBPACK_IMPORTED_MODULE_5__["chart"](_this.wellrank_chart_el.nativeElement, _this.wellrank_chart_options);
        }, function (error) {
        }, function () {
        });
    };
    WowsDashboardComponent.ctorParameters = function () { return [
...
var WowsPermissionGuard = /** @class */ (function () {
    function WowsPermissionGuard(router, wowsPermissionService) {
        this.router = router;
        this.wowsPermissionService = wowsPermissionService;
    }
    WowsPermissionGuard.prototype.canActivate = function (route, state) {
    ...
    WowsPermissionGuard.ctorParameters = function () { return [
...
var WowsPermissionService = /** @class */ (function () {
    function WowsPermissionService(router, authService) {
        var _this = this;
        this.router = router;
    ...
    WowsPermissionService.prototype.passPermission = function (path) {
        var _this = this;
        if (path.charAt(0) == "/")
    ...
    WowsPermissionService.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
var WowsRoutingModule = /** @class */ (function () {
    function WowsRoutingModule() {
    }
...
var WowsComponent = /** @class */ (function () {
    function WowsComponent(snackBar, titleService) {
    ...
    WowsComponent.ctorParameters = function () { return [
...
var PeModule = /** @class */ (function () {
    function PeModule(panelService, wowsPermission, authService) {
        var _this = this;
        this.panelService = panelService;
        this.wowsPermission = wowsPermission;
        this.authService = authService;
        this.authService.currentUser.subscribe(function (res) {
            _this.panelService.messageSource.next(new _navigation_panel_panel__WEBPACK_IMPORTED_MODULE_16__["Panel"]("WOWS", 2, [
                new _navigation_panel_panel__WEBPACK_IMPORTED_MODULE_16__["PanelItem"]("Dashboard", "wows/dashboard", "dashboard", _this.wowsPermission.passPermission("wows/dashboard")),
                new _navigation_panel_panel__WEBPACK_IMPORTED_MODULE_16__["PanelItem"]("Rig Barchart", "wows/rigchart", "bar_chart", _this.wowsPermission.passPermission("wows/rigchart")),
            ]));
        });
    }
    PeModule.ctorParameters = function () { return [
...
//# sourceMappingURL=wows-wows-module-es5.js.map