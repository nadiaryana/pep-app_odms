...
var SscDashboardComponent = /** @class */ (function () {
    function SscDashboardComponent(snackBar, route, commonService, titleService) {
        this.snackBar = snackBar;
        this.route = route;
        this.commonService = commonService;
        this.titleService = titleService;
    }
    SscDashboardComponent.prototype.ngOnInit = function () {
    ...
    SscDashboardComponent.prototype.onLoad = function (elm) {
    ...
    SscDashboardComponent.ctorParameters = function () { return [
...
var SscSlaMonthComponent = /** @class */ (function () {
    function SscSlaMonthComponent(http, router, dialog, 
    ...
    SscSlaMonthComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.titleService.titleSource.next({
            title: "SLA",
            icon: "",
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["merge"])(this.sort.sortChange, this.paginator.page, this.filterControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["debounceTime"])(300)), this.sla_month.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["debounceTime"])(300))).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])({}), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function () {
            ...
            var columnfilter = {};
            var date;
            if (_this.sla_month.value) {
                date = _this.sla_month.value;
            }
            else {
                date = new Date();
            }
    ...
    SscSlaMonthComponent.prototype.passPermission = function (path) {
        return this.sscPermissionService.passPermission(path);
    };
    SscSlaMonthComponent.prototype.monthChange = function (evt) {
    ...
    SscSlaMonthComponent.prototype.navigateTicket = function (group, status) {
    ...
    SscSlaMonthComponent.ctorParameters = function () { return [
...
var ExampleHttpDao = /** @class */ (function () {
    ...
    ExampleHttpDao.prototype.getRepoIssues = function (sort, order, page, pagesize, filter, columnfilter) {
...
var SscSlaComponent = /** @class */ (function () {
    function SscSlaComponent(snackBar) {
        this.snackBar = snackBar;
    }
    SscSlaComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] }
    ]; };
...
var SscSlaService = /** @class */ (function () {
    function SscSlaService(http) {
        this.http = http;
    }
    SscSlaService.prototype.add = function (_ssc_sla) {
        return this.http.post('Ssc/Sla/Add', _ssc_sla)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res;
        }));
    };
    SscSlaService.prototype.deleteSscSla = function (_ssc_sla) {
        return this.http.post('Ssc/Sla/Delete', _ssc_sla)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res;
        }));
    };
    SscSlaService.prototype.editSscSla = function (_ssc_sla) {
        return this.http.post('Ssc/Sla/Edit', _ssc_sla)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res;
        }));
    };
    SscSlaService.prototype.getOne = function (_ssc_sla) {
    ...
    SscSlaService.ctorParameters = function () { return [
...
var SscSla = /** @class */ (function () {
    function SscSla(ssc_sla_id, machine_id, presence_location_id, device_role, asset_name, location_name) {
        if (ssc_sla_id === void 0) { ssc_sla_id = 0; }
    ...
    SscSla.ctorParameters = function () { return [
        { type: Number },
        { type: Number },
        { type: Number },
        { type: String },
...
var SscPermissionGuard = /** @class */ (function () {
    function SscPermissionGuard(router, sscPermissionService) {
        this.router = router;
        this.sscPermissionService = sscPermissionService;
    }
    SscPermissionGuard.prototype.canActivate = function (route, state) {
    ...
    SscPermissionGuard.ctorParameters = function () { return [
...
var SscPermissionService = /** @class */ (function () {
    function SscPermissionService(router, authService) {
        var _this = this;
        this.router = router;
    ...
    SscPermissionService.prototype.passPermission = function (path) {
        var _this = this;
        var res = false;
        var ms = this.root.filter(function (m) { return path.indexOf(_this.basePath + '/' + m.link) != -1; });
        if (ms.length > 0) {
            var menu = ms[0];
    ...
    SscPermissionService.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
var SscComponent = /** @class */ (function () {
    function SscComponent(snackBar, titleService) {
        this.snackBar = snackBar;
        this.titleService = titleService;
        this.titleService.titleSource.next({
            title: "ICT",
    ...
    SscComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] },
...
var SscModule = /** @class */ (function () {
    function SscModule(panelService, sscPermission, authService) {
        var _this = this;
        this.panelService = panelService;
        this.sscPermission = sscPermission;
        this.authService = authService;
        this.authService.currentUser.subscribe(function (res) {
            _this.panelService.messageSource.next(new _navigation_panel_panel__WEBPACK_IMPORTED_MODULE_18__["Panel"]("ICT", 1, [
                new _navigation_panel_panel__WEBPACK_IMPORTED_MODULE_18__["PanelItem"]("Dashboard", "ssc/dashboard", "dashboard", _this.sscPermission.passPermission("ssc/dashboard")),
                new _navigation_panel_panel__WEBPACK_IMPORTED_MODULE_18__["PanelItem"]("Open Tickets", "ssc/ticket/open", "list", _this.sscPermission.passPermission("ssc/ticket")),
                new _navigation_panel_panel__WEBPACK_IMPORTED_MODULE_18__["PanelItem"]("All Tickets", "ssc/ticket/list", "list", _this.sscPermission.passPermission("ssc/ticket")),
                new _navigation_panel_panel__WEBPACK_IMPORTED_MODULE_18__["PanelItem"]("SLA", "ssc/sla", "show_chart", _this.sscPermission.passPermission("ssc/sla")),
            ]));
        });
    }
    SscModule.ctorParameters = function () { return [
...
var SscTicketListComponent = /** @class */ (function () {
    function SscTicketListComponent(http, router, dialog, 
    //public snackBar: MatSnackBar,
    ...
    SscTicketListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.titleService.titleSource.next({
            title: "All Tickets",
            icon: "",
    ...
    SscTicketListComponent.prototype.ngOnDestroy = function () {
        this.filterSubscription.unsubscribe();
        this.selectedSubscription.unsubscribe();
        this.listSubscription.unsubscribe();
    };
    SscTicketListComponent.prototype.passPermission = function (path) {
        return this.sscPermissionService.passPermission(path);
    };
    SscTicketListComponent.prototype.getColumnValues = function (param) {
        var _this = this;
        ...
        return this.exampleDatabase.getRepoIssues(this.sort.active, this.sort.direction, this.paginator.pageIndex, this.paginator.pageSize, this.filterControl.value, columnfilter, column).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (res) {
            return res;
    ...
    SscTicketListComponent.prototype.getColumnFilter = function () {
        var columnfilter = {};
    ...
    SscTicketListComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"] },
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialog"] },
...
var SscTicketOpenComponent = /** @class */ (function () {
    function SscTicketOpenComponent(http, router, dialog, 
    //public snackBar: MatSnackBar,
    ...
    SscTicketOpenComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.titleService.titleSource.next({
            title: "Open Tickets",
            icon: "",
    ...
    SscTicketOpenComponent.prototype.ngOnDestroy = function () {
        this.filterSubscription.unsubscribe();
        this.selectedSubscription.unsubscribe();
        this.listSubscription.unsubscribe();
    };
    SscTicketOpenComponent.prototype.passPermission = function (path) {
        return this.sscPermissionService.passPermission(path);
    };
    SscTicketOpenComponent.prototype.getColumnValues = function (param) {
        var _this = this;
        var column = param["column"];
        var filter = param["filter"];
        var selected = param["selected"];
    ...
    SscTicketOpenComponent.prototype.getColumnFilter = function () {
        var columnfilter = {};
        if (this.id_xSelected.length)
            columnfilter["id"] = this.id_xSelected;
        if (this.type_xSelected.length)
    ...
    SscTicketOpenComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_7__["Router"] },
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialog"] },
        { type: _ssc_ticket_service__WEBPACK_IMPORTED_MODULE_8__["SscTicketService"] },
...
var SscTicketComponent = /** @class */ (function () {
    function SscTicketComponent(snackBar) {
        this.snackBar = snackBar;
    }
    SscTicketComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] }
    ]; };
...
var SscTicketService = /** @class */ (function () {
    function SscTicketService(http) {
        this.http = http;
    }
    SscTicketService.prototype.add = function (_ssc_ticket) {
        return this.http.post('Ssc/Ticket/Add', _ssc_ticket)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res;
        }));
    };
    SscTicketService.prototype.deleteSscTicket = function (_ssc_ticket) {
        return this.http.post('Ssc/Ticket/Delete', _ssc_ticket)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res;
        }));
    };
    SscTicketService.prototype.editSscTicket = function (_ssc_ticket) {
        return this.http.post('Ssc/Ticket/Edit', _ssc_ticket)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res;
        }));
    };
    SscTicketService.prototype.getOne = function (_ssc_ticket) {
    ...
    SscTicketService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var SscTicket = /** @class */ (function () {
    function SscTicket(ssc_ticket_id, machine_id, presence_location_id, device_role, asset_name, location_name) {
        if (ssc_ticket_id === void 0) { ssc_ticket_id = 0; }
        if (asset_name === void 0) { asset_name = ""; }
        if (location_name === void 0) { location_name = ""; }
    ...
    SscTicket.ctorParameters = function () { return [
        { type: Number },
        { type: Number },
        { type: Number },
        { type: String },
...
//# sourceMappingURL=ssc-ssc-module-es5.js.map