...
var PoDashboardComponent = /** @class */ (function () {
    function PoDashboardComponent(http, titleService, commonService, route, router, locale) {
        this.http = http;
    ...
    PoDashboardComponent.prototype.ngOnInit = function () {
    ...
    PoDashboardComponent.ctorParameters = function () { return [
...
var PoPermissionGuard = /** @class */ (function () {
    function PoPermissionGuard(router, poPermissionService) {
        this.router = router;
        this.poPermissionService = poPermissionService;
    }
    PoPermissionGuard.prototype.canActivate = function (route, state) {
    ...
    PoPermissionGuard.ctorParameters = function () { return [
...
var PoPermissionService = /** @class */ (function () {
    function PoPermissionService(router, authService) {
        var _this = this;
        this.router = router;
    ...
    PoPermissionService.prototype.passPermission = function (path) {
        var _this = this;
        ...
        console.log(path);
        var res = false;
        var ms = this.root.filter(function (m) { return path == _this.basePath + '/' + m.link; });
        console.log(ms);
        if (ms.length > 0) {
            var menu = ms[0];
    ...
    PoPermissionService.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    ...
    return PoPermissionService;
}());

var Menu = /** @class */ (function () {
    function Menu(link, auth, parameter, permission) {
...
var PoRoutingModule = /** @class */ (function () {
    function PoRoutingModule() {
    }
...
var PoComponent = /** @class */ (function () {
    function PoComponent(snackBar, titleService) {
...
/* harmony import */ var angular_highcharts__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! angular-highcharts */ "./node_modules/angular-highcharts/fesm5/angular-highcharts.js");
...
var PoModule = /** @class */ (function () {
    function PoModule(panelService, poPermission, authService) {
        var _this = this;
        this.panelService = panelService;
        this.poPermission = poPermission;
        this.authService = authService;
        this.authService.currentUser.subscribe(function (res) {
            _this.panelService.messageSource.next(new _navigation_panel_panel__WEBPACK_IMPORTED_MODULE_21__["Panel"]("Production Operation", 2, [
                new _navigation_panel_panel__WEBPACK_IMPORTED_MODULE_21__["PanelItem"]("Dashboard", "po/dashboard", "dashboard", _this.poPermission.passPermission("po/dashboard")),
                new _navigation_panel_panel__WEBPACK_IMPORTED_MODULE_21__["PanelItem"]("Propar Template", "po/propar", "list", _this.poPermission.passPermission("po/propar")),
            ]));
        });
    }
    PoModule.ctorParameters = function () { return [
...
var PoProparAddComponent = /** @class */ (function () {
    function PoProparAddComponent(formBuilder, router, snackbarService, dialogService, titleService, http) {
    ...
    PoProparAddComponent.prototype.onSubmit = function () {
        this.loading = true;
    ...
    Object.defineProperty(PoProparAddComponent.prototype, "f", {
        get: function () { return this.proparForm.controls; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(PoProparAddComponent.prototype, "opsog_array", {
        get: function () { return this.opsogForm.get('opsog_array'); },
        enumerable: true,
        configurable: true
    });
    PoProparAddComponent.prototype.ngOnInit = function () {
        this.titleService.titleSource.next({
            title: "Add Propar",
            icon: "add",
            breadcrumbs: [
    ...
    ;
    PoProparAddComponent.prototype.addOpsogForm = function () {
        var addForm = this.opsogForm.get('opsog_array');
    ...
    PoProparAddComponent.prototype.removeOpsogForm = function (index) {
        var removeForm = this.opsogForm.get('opsog_array');
        removeForm.removeAt(index);
    };
    PoProparAddComponent.prototype.listPropar = function () {
        this.router.navigate(['po', 'propar', 'list']);
    };
    PoProparAddComponent.prototype.canDeactivate = function () {
        if (this.proparForm.pristine) {
            return true;
        }
        return this.dialogService.confirm('Discard changes?');
    };
    PoProparAddComponent.prototype.handleFile = function (event) {
    ...
    PoProparAddComponent.prototype.onUpload = function () {
        var _this = this;
        var fd = new FormData();
        ...
        this.http.post('/api/po/propar/UploadFiles', fd, {
            ...
            if (error) {
                _this.isUploading = false;
                _this.resetData();
                _this.snackbarService.status.next(new _snackbar_service__WEBPACK_IMPORTED_MODULE_6__["SnackbarApi"](true, "Wrong template file!", 'dismiss'));
            }
        });
    };
    PoProparAddComponent.prototype.onSaveOpsog = function () {
        this.isUploading = true;
    ...
    PoProparAddComponent.prototype.loadData = function () {
        var _this = this;
        this.isLoading = true;
        var httpOption = {
            params: {
        ...
        this.http.get('/api/po/propar/Tmp', httpOption).subscribe(function (res) {
    ...
    PoProparAddComponent.prototype.saveData = function () {
        var _this = this;
        this.isSaving = true;
        this.http.get('/api/po/propar/SaveData', { params: { _id: this.tmp_id } }).subscribe(function (res) {
    ...
    PoProparAddComponent.prototype.resetData = function () {
        this.isUploading = false;
        this.isLoading = false;
        this.isSaving = false;
        this.modified_count = 0;
    ...
    PoProparAddComponent.prototype.formatInterval = function (arr) {
        return arr.map(function (a) { return a.join("-"); }).join(", ");
    };
    PoProparAddComponent.prototype.unloadNotification = function ($event) {
        return this.proparForm.pristine;
    };
    PoProparAddComponent.ctorParameters = function () { return [
...
var PoProparEditComponent = /** @class */ (function () {
    function PoProparEditComponent(snackBar) {
        this.snackBar = snackBar;
    }
    PoProparEditComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] }
    ]; };
...
var PoProparListComponent = /** @class */ (function () {
    function PoProparListComponent(http, router, dialog, snackBar, po_proparService, snackbarService, poPermissionService, titleService, route, xfilterService, commonService) {
        this.http = http;
        this.router = router;
        this.dialog = dialog;
        this.snackBar = snackBar;
    ...
    PoProparListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.titleService.titleSource.next({
    ...
    PoProparListComponent.prototype.ngOnDestroy = function () {
        this.filterSubscription.unsubscribe();
        this.selectedSubscription.unsubscribe();
        this.listSubscription.unsubscribe();
    };
    PoProparListComponent.prototype.passPermission = function (path) {
        return this.poPermissionService.passPermission(path);
    };
    PoProparListComponent.prototype.exportExcel = function () {
        var _this = this;
        var httpOption = {
            observe: 'response',
        ...
        this.exampleDatabase.getRepoIssues(this.sort.active, this.sort.direction, this.paginator.pageIndex, this.paginator.pageSize, this.filterControl.value, columnfilter, "excel", httpOption).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (res) {
            _this.isLoadingResults = false;
            return {
            ...
            _this.isLoadingResults = false;
            _this.snackbarService.status.next(new _snackbar_service__WEBPACK_IMPORTED_MODULE_11__["SnackbarApi"](true, error['message'], 'dismiss'));
            console.log(error);
        }, function () {
            console.log('Completed file download.');
        });
    };
    PoProparListComponent.prototype.getColumnValues = function (param) {
        var _this = this;
        ...
        return this.exampleDatabase.getRepoIssues(this.sort.active, this.sort.direction, this.paginator.pageIndex, this.paginator.pageSize, this.filterControl.value, columnfilter, column).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (res) {
            return res;
        })).subscribe(function (res) {
    ...
    PoProparListComponent.prototype.getColumnFilter = function () {
        var columnfilter = {};
    ...
    PoProparListComponent.prototype.formatInterval = function (arr) {
        return arr.map(function (a) { return a.join("-"); }).join(", ");
    };
    /** Whether the number of selected elements matches the total number of rows. */
    PoProparListComponent.prototype.isAllSelected = function () {
        var numSelected = this.selection.selected.length;
        var numRows = this.dataSource.data.length;
        return numSelected === numRows;
    };
    /** Selects all rows if they are not all selected; otherwise clear selection. */
    PoProparListComponent.prototype.masterToggle = function () {
        var _this = this;
        this.isAllSelected() ?
    ...
    PoProparListComponent.prototype.deleteSelected = function () {
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
                _this.isLoadingResults = true;
                _this.snackbarService.status.next(new _snackbar_service__WEBPACK_IMPORTED_MODULE_11__["SnackbarApi"](false));
                _this.http.delete('/api/po/propar', {
                    headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                        'Content-Type': 'application/json'
                    }),
                    params: {
                    ...
                    _this.isLoadingResults = false;
                    _this.snackbarService.status.next(new _snackbar_service__WEBPACK_IMPORTED_MODULE_11__["SnackbarApi"](true, res["deleted_count"] + " item(s) deleted successfully.", "dismiss"));
    ...
    PoProparListComponent.ctorParameters = function () { return [
...
var ExampleHttpDao = /** @class */ (function () {
    ...
    ExampleHttpDao.prototype.getRepoIssues = function (sort, order, page, pagesize, filter, columnfilter, mode, httpOption) {
...
var PoProparDeleteDialogComponent = /** @class */ (function () {
    function PoProparDeleteDialogComponent(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
    }
    PoProparDeleteDialogComponent.prototype.onNoClick = function () {
        this.dialogRef.close();
    };
    PoProparDeleteDialogComponent.prototype.onYesClick = function () {
        this.dialogRef.close();
    };
    PoProparDeleteDialogComponent.ctorParameters = function () { return [
    ...
    return PoProparDeleteDialogComponent;
}());
...
var PoProparComponent = /** @class */ (function () {
    function PoProparComponent(http, titleService, commonService, route, router, locale) {
        this.http = http;
        this.titleService = titleService;
        this.commonService = commonService;
        this.route = route;
    ...
    PoProparComponent.prototype.ngOnInit = function () {
        this.titleService.titleSource.next({
            title: "Propar Template",
            icon: "list",
            breadcrumbs: [
    ...
    PoProparComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
        { type: _navigation_title_title_service__WEBPACK_IMPORTED_MODULE_7__["TitleService"] },
        { type: _common_service__WEBPACK_IMPORTED_MODULE_6__["CommonService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
...
var PoProparService = /** @class */ (function () {
    function PoProparService(http) {
        this.http = http;
    }
    PoProparService.prototype.add = function (_po_propar) {
        return this.http.post('Po/Propar/Add', _po_propar)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res;
        }));
    };
    PoProparService.prototype.deletePoPropar = function (_po_propar) {
        return this.http.post('Po/Propar/Delete', _po_propar)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res;
        }));
    };
    PoProparService.prototype.editPoPropar = function (_po_propar) {
        return this.http.post('Po/Propar/Edit', _po_propar)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res;
        }));
    };
    PoProparService.prototype.getOne = function (_po_propar) {
    ...
    PoProparService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var PoPropar = /** @class */ (function () {
    function PoPropar(_id, machine_id, presence_location_id, device_role, asset_name, location_name) {
        if (asset_name === void 0) { asset_name = ""; }
    ...
    PoPropar.ctorParameters = function () { return [
        { type: String },
        { type: Number },
        { type: Number },
        { type: String },
...
var PoProparError = /** @class */ (function () {
    function PoProparError(po_propar_id) {
        if (po_propar_id === void 0) { po_propar_id = 0; }
        this.po_propar_id = po_propar_id;
    }
    PoProparError.ctorParameters = function () { return [
        { type: Number }
    ]; };
    return PoProparError;
}());
...
//# sourceMappingURL=po-po-module-es5.js.map